      ...
      <div className="flex-none">
        ...
        >
          <button className="btn btn-square btn-ghost">
            <svg
              style={{
                background:
                  "linear-gradient(45deg, rgb( 255, 0, 80), rgba(0, 242, 234,1))",
                boxShadow: "0 0 15px rgba(0, 242, 234,1)",
                borderRadius: "25%",
                color: "#000",
              }}
        ...
        >
          <button className="btn btn-square btn-ghost">
            <svg
              style={{
                backgroundColor: " rgb(245,1,202)",
                borderRadius: "25%",
                boxShadow: "0 0 20px rgb(247,2,94)",
              }}
              xmlns="http://www.w3.org/2000/svg"
              height="1.5em"
              viewBox="0 0 448 512"
          ...
          <button className="btn btn-square btn-ghost">
            <svg
              style={{
                ...
                boxShadow: "0 0 20px rgb(255,255,0)",
                borderRadius: "25%",
              }}
              xmlns="http://www.w3.org/2000/svg"
              height="1.5em"
